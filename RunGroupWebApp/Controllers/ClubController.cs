...
namespace RunGroupWebApp.Controllers
{
    public class ClubController : Controller
    {
        ...
        {
            var clubs = await _clubRepository.GetClubsByState(StateConvertor.GetStateByName(state).ToString());
        ...
        {
            var cities = await _clubRepository.GetAllCitiesByState(StateConvertor.GetStateByName(state).ToString());
